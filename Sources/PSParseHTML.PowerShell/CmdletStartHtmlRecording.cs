...
/// </summary>
[Cmdlet(VerbsLifecycle.Start, "HTMLRecording", DefaultParameterSetName = ParameterSetSession)]
[OutputType(typeof(HtmlBrowserSession))]
public sealed class CmdletStartHtmlRecording : AsyncPSCmdlet {
    ...
    protected override async Task ProcessRecordAsync() {
        ...
        HtmlBrowserSession sess = ParameterSetName == ParameterSetSession
            ? await HtmlBrowser.StartRecordingAsync(
                Session!,
                OutFile,
                headless,
                SlowMo,
