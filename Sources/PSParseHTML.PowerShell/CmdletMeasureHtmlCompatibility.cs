...
/// <summary>Reports common HTML compatibility, accessibility, and resource URL issues.</summary>
/// <example>
///   <summary>Find generated-page issues</summary>
///   <code>Measure-HtmlCompatibility -Content '&lt;img src="logo.png"&gt;&lt;input id="email"&gt;'</code>
/// </example>
[Cmdlet(VerbsDiagnostic.Measure, "HtmlCompatibility", DefaultParameterSetName = ParameterSetContent)]
[OutputType(typeof(HtmlCompatibilityFinding))]
public sealed class CmdletMeasureHtmlCompatibility : AsyncPSCmdlet {
    ...
    /// <summary>Base URL used to resolve relative resource URLs. Defaults to Url when downloading.</summary>
    [Parameter]
    ...
    protected override async Task ProcessRecordAsync() {
        ...
        WriteObject(HtmlWorkflowParser.MeasureCompatibility(html, baseUri).ToArray(), true);
    }
