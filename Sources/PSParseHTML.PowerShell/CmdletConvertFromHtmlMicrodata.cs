...
/// <summary>
/// Parses schema.org microdata items from HTML content or a URL.
/// </summary>
...
public sealed class CmdletConvertFromHtmlMicrodata : AsyncPSCmdlet {
    ...
    /// <summary>HTML content containing microdata.</summary>
    ...
    /// <summary>Proxy server address when downloading from a URL.</summary>
    [Parameter]
    ...
    protected override async Task ProcessRecordAsync() {
        ...
        if (ParameterSetName == ParameterSetUrl) {
            ...
            items = await HtmlParser.ParseUrlMicrodataAsync(Url.ToString(), client).ConfigureAwait(false);
        } else {
            items = HtmlParser.ParseMicrodata(Content);
        }
