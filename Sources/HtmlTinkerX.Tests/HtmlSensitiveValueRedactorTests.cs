...
public class HtmlSensitiveValueRedactorTests {
    ...
    public void RedactSensitiveEvidenceText_RedactsSensitiveTextareasAndPasswordInputs() {
        string redacted = HtmlSensitiveValueRedactor.RedactSensitiveEvidenceText(
            "<form><textarea name=\"SAMLResponse\">textarea-saml-secret</textarea><textarea name=\"notes\">visible note</textarea><input type=\"password\" value=\"password-secret\"><input name=password value=unquoted-secret><input name=\"display\" value=\"visible-value\"></form>");
        ...
        Assert.Contains("name=password value=<redacted>", redacted, System.StringComparison.Ordinal);
        ...
        Assert.DoesNotContain("unquoted-secret", redacted, System.StringComparison.Ordinal);
    }
}
