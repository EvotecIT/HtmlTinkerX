...
public static partial class HtmlBrowser {
    ...
    public static Task CaptureResponseBodiesAsync(
        ...
        int maxBytes,
        IEnumerable<HtmlNetworkResourceType>? resourceTypes,
        CancellationToken cancellationToken) =>
        CaptureResponseBodiesAsync(session, maxBytes, resourceTypes, cancellationToken, redactSensitiveValues: false);
