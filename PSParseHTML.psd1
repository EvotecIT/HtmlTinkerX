@{
    ...
    CmdletsToExport        = @('Optimize-Email', 'Convert-HTMLToText', 'Optimize-HTML')
    CompanyName            = 'Evotec'
    ...
    FunctionsToExport      = @('ConvertFrom-HTML', 'ConvertFrom-HTMLAttributes', 'ConvertFrom-HtmlTable', 'Format-CSS', 'Format-HTML', 'Format-JavaScript', 'Optimize-CSS', 'Optimize-JavaScript')
