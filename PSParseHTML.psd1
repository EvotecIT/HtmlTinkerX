@{
    ...
    CmdletsToExport        = @('Convert-HTMLToText', 'ConvertFrom-HTML', 'Format-CSS', 'Format-JavaScript', 'Format-HTML', 'Optimize-CSS', 'Optimize-Email', 'Optimize-HTML', 'Optimize-JavaScript', 'ConvertFrom-HTMLAttributes')
    CompanyName            = 'Evotec'
