@{
    ...
    CmdletsToExport        = @('Optimize-Email', 'Convert-HTMLToText', 'Format-JavaScript')
    CompanyName            = 'Evotec'
    ...
    FunctionsToExport      = @('ConvertFrom-HTML', 'ConvertFrom-HTMLAttributes', 'ConvertFrom-HtmlTable', 'Format-CSS', 'Format-HTML', 'Optimize-CSS', 'Optimize-HTML', 'Optimize-JavaScript')
