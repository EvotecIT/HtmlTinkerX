@{
    ...
    CmdletsToExport        = @('Convert-HTMLToText', 'Format-CSS', 'Format-JavaScript', 'Optimize-CSS', 'Optimize-Email', 'Optimize-HTML', 'Optimize-JavaScript')
    CompanyName            = 'Evotec'
    ...
    FunctionsToExport      = @('ConvertFrom-HTML', 'ConvertFrom-HTMLAttributes', 'ConvertFrom-HtmlTable', 'Format-HTML')
