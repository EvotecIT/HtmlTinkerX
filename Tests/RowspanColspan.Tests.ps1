Describe 'Rowspan/Colspan table parsing' {
    It 'Parses table with rowspan/colspan correctly - AgilityPack' {
        ...
        $Table.Data[0].Values.Item | Should -Be 'Apples'
        $Table.Data[0].Values.Q1 | Should -Be '1'
        $Table.Data[0].Values.Q2 | Should -Be '2'
        $Table.Data[0].Values.Q3 | Should -Be '3'
        $Table.Data[1].Values.Item | Should -Be 'Apples'
        $Table.Data[1].Values.Q1 | Should -Be '4'
        $Table.Data[1].Values.Q2 | Should -Be '4'
        $Table.Data[1].Values.Q3 | Should -Be '5'
    }
